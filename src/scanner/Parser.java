...
public class Parser {
    ...
    public void analisar() throws CompiladorException, IOException {
        ...
        for (ItemTabela i : this.tabela) {
            System.out.println("Objeto: ");
            System.out.print("Escopo: " + i.getEscopo() + " ");
            System.out.print("Lexema: " + i.getLexema() + " ");
            System.out.println("Tipo: " + i.getSimbolo());
        }
